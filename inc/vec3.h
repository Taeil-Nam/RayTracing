...
t_vec3  vec3_random(); //random vec3
...
t_vec3  vec3_random_in_unit_sphere(); //return vector in unitsphere
t_vec3  vec3_random_unit(); //return random unit vector
t_vec3  vec3_reflect(t_vec3 *v, t_vec3 *n); //return reflect vector]
t_vec3  vec3_refract(t_vec3 *uv, t_vec3 *n, double etai_over_etat); // return refract vector
